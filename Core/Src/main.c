...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, WD_EN_Pin|WWDG_GPIO_Pin|MZ_DIR_Pin|MY_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(IMU_NRST_GPIO_Port, IMU_NRST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, MCU_LED_Pin|BLE_STATE_Pin|FRAM_CS1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, QSPI_NCS_2_Pin|QSPI_NCS_3_Pin|MX_DIR_Pin|I2C1_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, FRAM_CS3_Pin|FRAM_CS2_Pin|GPS_EN_Pin|USER_3_Pin
                          |USER_2_Pin|USER_1_Pin|USER_0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : WD_EN_Pin WWDG_GPIO_Pin MZ_DIR_Pin MY_DIR_Pin */
  GPIO_InitStruct.Pin = WD_EN_Pin|WWDG_GPIO_Pin|MZ_DIR_Pin|MY_DIR_Pin;
  ...
  /*Configure GPIO pins : MCU_LED_Pin BLE_STATE_Pin FRAM_CS1_Pin */
  GPIO_InitStruct.Pin = MCU_LED_Pin|BLE_STATE_Pin|FRAM_CS1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pins : QSPI_NCS_2_Pin QSPI_NCS_3_Pin MX_DIR_Pin I2C1_EN_Pin */
  GPIO_InitStruct.Pin = QSPI_NCS_2_Pin|QSPI_NCS_3_Pin|MX_DIR_Pin|I2C1_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
