...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN16
    */
    HAL_GPIO_DeInit(IMON_3V3_GPIO_Port, IMON_3V3_Pin);

    HAL_GPIO_DeInit(GPIOB, IMON_5V_Pin|VBAT_MON_Pin);
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PD13     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = MX_A_Pin|MX_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM3)
  {
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, MZ_B_Pin|MZ_A_Pin);
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, MX_A_Pin|MX_B_Pin);
  ...
  else if(htim_encoder->Instance==TIM5)
  {
    ...
    PF7     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOF, MY_B_Pin|MY_A_Pin);
