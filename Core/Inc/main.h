...
#define WWDG_GPIO_Pin GPIO_PIN_6
#define WWDG_GPIO_GPIO_Port GPIOE
#define IMU_NRST_Pin GPIO_PIN_2
#define IMU_NRST_GPIO_Port GPIOF
...
#define QSPI_NCS_2_Pin GPIO_PIN_12
#define QSPI_NCS_2_GPIO_Port GPIOB
#define QSPI_NCS_3_Pin GPIO_PIN_13
#define QSPI_NCS_3_GPIO_Port GPIOB
#define MX_PWM_Pin GPIO_PIN_14
#define MX_PWM_GPIO_Port GPIOB
#define MX_DIR_Pin GPIO_PIN_15
#define MX_DIR_GPIO_Port GPIOB
#define MX_A_Pin GPIO_PIN_12
#define MX_A_GPIO_Port GPIOD
#define MX_B_Pin GPIO_PIN_13
